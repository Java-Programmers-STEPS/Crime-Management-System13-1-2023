	...
	<div class="content">
		<form action="officer_home_page.jsp" method=""onsubmit="return firvalidation()">
			<div class="user-details">
				<div class="input-box">
					<span class="details">FIR Registration Number</span> <input
						type="number" name="firregistrationnumber"
						id="firregistrationnumber" placeholder="Enter reg no">
				</div>
